// Website Protection Script for Inksnap Nigeria - FIXED VERSION
// This script implements multiple layers of protection against copying
// WITHOUT interfering with normal website usage
...
(function() {
    ...
    // Protection Level 6: Detect Developer Tools (LESS AGGRESSIVE)
    let devtools = {
        open: false,
        orientation: null
    };
    ...
    // Protection Level 13: IMPROVED mouse tracking (LESS AGGRESSIVE)
    ...
    document.addEventListener('mousemove', function() {
        ...
        // Only check for suspicious activity every 5 seconds
        if (now - lastMouseTime > 5000) {
            if (mouseMovements > 5000) { // Much higher threshold
    ...
    console.log('🛡️ Inksnap Nigeria Website Protection Active (Fixed Version)');
